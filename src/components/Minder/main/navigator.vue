<template lang="html">
  <div class="navigator">
    <div class="nav-bar">
      <div class="nav-btn zoom-in" title="放大" :class="{ 'active' : zoomRadioIn }" @click="zoomIn">
        <i class="icon" />
      </div>
      <div class="zoom-pan">
      ...
      <div class="nav-btn zoom-out" title="缩小" :class="{ 'active' : zoomRadioOut }" @click="zoomOut">
        <div class="icon" />
      </div>
      <div class="nav-btn hand" title="拖拽" :class="{ 'active' : enableHand }" @click="hand">
        <div class="icon" />
      </div>
      <div class="nav-btn camera" title="定位根节点" @click="locateToOrigin">
        <div class="icon" />
      </div>
      <div class="nav-btn nav-trigger" :class="{'active' : isNavOpen}" title="导航器" @click="toggleNavOpen">
        <div class="icon" />
      </div>
    ...
    <div v-show="isNavOpen" class="nav-previewer" />
  </div>
</template>
