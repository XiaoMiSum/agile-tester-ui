<template>
  <div class="insert-group" style="width: 60px">
    <ul style="padding-inline-start: 7px;list-style: none;width: 40px;margin-top:0px;margin-left: 15px" :class="commandDisabled">
      <li :class="undoActive" :active="false" @click="handleUndo">
        <i class="el-icon-back" title="撤销" style="font-size: 25px;cursor: pointer;" />
      </li>

      <li :class="redoActive" @click="handleRedo">
        <i class="el-icon-right" title="重做" style="font-size: 25px;cursor: pointer;" />
      </li>
    </ul>
  </div>
</template>
